...
public class IndustrialRobotsExample {
    ...
    private void runExample() {
        ...
        // Zapis wag SMAA do plików CSV (roboty)
        var weights = smaaEfficiency.generateWeightSamples(data);
        try {
            weights.getInputSamples().write().csv("robots_input_weights.csv");
            weights.getOutputSamples().write().csv("robots_output_weights.csv");
            System.out.println("Zapisano wagi SMAA do plików CSV (robots_input_weights.csv oraz robots_output_weights.csv)");
        } catch (Exception e) {
